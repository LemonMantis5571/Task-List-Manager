    ...
    <div>
        <Formik
            ...
            {({isSubmitting, resetForm}) => (
                <div className='d-flex justify-content-center align-items-center w-100 h-100 form-div'>
                    <Form className='form-parent mt-3 d-flex flex-column align-items-center justify-content-center align-self'>
                        <div className='mb-3'>
                        ...
                        <div>
                            <button type="submit" onClick={() => resetForm()} className='btn btn-success'>Create Task</button>
